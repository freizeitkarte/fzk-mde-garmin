gmt v0.8.221.854b  26.07.2015 CC BY-SA (C) 2011-2015 AP www.gmaptool.eu
---------------------------------------------------------------------------
...
This is experimental release for Mac OS. Program was compiled under Mac OS C 10.10. I haven't any experience with Mac OS and I'm not able to support this version. Use it if it works.
